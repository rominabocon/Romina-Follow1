...
$email_message .= "Parques: " . $_POST['inp_wdw'] . "\n";
$email_message .= "Parques: " . $_POST['inp_uso'] . "\n";
$email_message .= "Parques: " . $_POST['inp_disl'] . "\n";
$email_message .= "Parques: " . $_POST['inp_ush'] . "\n";
$email_message .= "Parques: " . $_POST['inp_ots'] . "\n";
